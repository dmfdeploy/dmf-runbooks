...
Thin AWX launcher playbooks plus the currently-authoritative `nmos-cpp` role for the DMF Platform. See README.md and CLAUDE.md for repo specifics; cross-repo context —
